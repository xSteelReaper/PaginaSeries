...
urlpatterns = [
    ...
    path('/catalogo', TemplateView.as_view(template_name='animecatalogo.html'), name='animecatalogo'),
    path('/catalogo2', TemplateView.as_view(template_name='mangacatalogo.html'), name='mangacatalogo'),
